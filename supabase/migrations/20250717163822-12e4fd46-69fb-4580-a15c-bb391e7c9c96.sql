-- Security Fix: Add explicit search_path to all database functions and optimize OTP settings
...
-- Optimize OTP security settings
ALTER SYSTEM SET session_preload_libraries = 'auto_explain';

-- Set more secure OTP expiry (3 minutes instead of 5 for better security)
-- This will be handled in the security configuration
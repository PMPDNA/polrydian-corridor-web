...
-- Create simpler unique index for insights
CREATE UNIQUE INDEX IF NOT EXISTS idx_insights_source_series_date 
ON insights (data_source, series_id, created_at::date);
